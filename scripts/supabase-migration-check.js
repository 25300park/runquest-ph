...
const requiredTables = {
  ...
  payment_fraud_logs: ['id', 'user_id', 'payment_provider', 'fraud_score', 'risk_level', 'action'],
  subscription_changes: ['id', 'user_id', 'from_plan', 'to_plan', 'change_type'],
  enterprise_accounts: ['id', 'company_name', 'billing_email', 'status', 'seats'],
  enterprise_users: ['id', 'enterprise_account_id', 'user_id', 'role', 'status'],
  invoices: ['id', 'enterprise_account_id', 'invoice_number', 'amount_cents', 'status'],
  ai_revenue_optimizations: ['id', 'segment', 'input_hash', 'pricing_suggestion', 'retention_strategy'],
  kpi_reports: ['id', 'report_date', 'period', 'metrics', 'anomalies'],
  board_reports: ['id', 'report_date', 'company_health_score', 'revenue_trend', 'ai_insights'],
  ai_business_strategies: ['id', 'strategy_week', 'input_hash', 'recommendations', 'explainability'],
  company_valuations: ['id', 'valuation_date', 'arr_cents', 'valuation_low_cents', 'risk_adjusted_valuation_cents'],
  global_expansion_intelligence: ['id', 'report_month', 'top_regions', 'recommended_next_market', 'expansion_roadmap'],
